...
void setup() {
  ...
  RSpeed_G = new Meter(this, meter_scale, 0);
  ...
  LPower_G = new Meter(this, 0, (meter_scale * (120/200)));
  ...
  RPower_G = new Meter(this, meter_scale, (meter_scale/1.5));
